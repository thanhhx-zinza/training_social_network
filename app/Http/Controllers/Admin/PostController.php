...
class PostController extends BaseAdminController
{
    ...
    {
        if (Gate::forUser($this->currentAdmin())->allows('post-list')) {
    ...
    {
        if (Gate::forUser($this->currentAdmin())->allows('post-edit')) {
    ...
    {
        if (Gate::forUser($this->currentAdmin())->allows('post-delete')) {
