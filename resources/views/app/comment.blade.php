...
<div class="container">
    ...
    <div class="row">
    <textarea name="comment_text" id="content_post" class="form-control" cols="30" rows="3" readonly>{{$post->content}}</textarea>
    </div>
</div>
<!-- end code post -->
...
<!-- begin comments -->
    <h3>Comments ({{count($post->comment)}})</h3>
    <div class="comment">
            ...
            <div class="media row">
                ...
                <div class="col-9">
                    <div class="media-body">
                        ...
                        <div class="row">{{$comments->content}}</div>
                        <div class="row">
                            <div class="col-2">
