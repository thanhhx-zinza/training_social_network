...
@foreach($post as $posts)
    ...
    <div class="container">
        ...
        <div class="row">
        <textarea name="comment_text" class="form-control" cols="30" rows="3" readonly>{{$posts->content}}</textarea>
        </div>
    </div>
    <!-- end code post -->
